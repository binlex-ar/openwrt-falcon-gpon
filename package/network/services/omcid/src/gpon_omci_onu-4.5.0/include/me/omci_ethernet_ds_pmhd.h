...
******************************************************************************/
#ifndef _omci_ethernet_ds_pmhd_h
#define _omci_ethernet_ds_pmhd_h
...
/** \defgroup OMCI_ME_ETHERNET_PMHD_DS Ethernet Frame Performance Monitoring History Data Downstream Managed Entity

    This Managed Entity collects performance monitoring data associated with
    downstream Ethernet frame delivery. It it based on the Etherstats group of
...
/** This structure holds the attributes of the Ethernet Frame Performance
    Monitoring History Data Downstream Managed Entity.
*/
struct omci_me_ethernet_ds_pmhd {
	/** Interval End Time
	...
	*/
	...
	/** Received Octet (Byte) Count
	    ...
	    The total number of octets received from the OLT, including those in
	...
	*/
	...
	/** Received Packet Count
	    ...
	    The total number of packets received in downstream direction,
	...
	*/
	...
	/** Received Broadcast Packet Count
	    ...
	    The total number of received good packets in downstream direction
...
/** This enumerator holds the attribute numbers of the Ethernet Frame
   Performance Monitoring History Data Downstream Managed Entity.
*/
enum {
	omci_me_ethernet_ds_pmhd_interval_end_time = 1,
	omci_me_ethernet_ds_pmhd_thr_data_id = 2,
	omci_me_ethernet_ds_pmhd_drop_event_count = 3,
	omci_me_ethernet_ds_pmhd_rx_byte_count = 4,
	omci_me_ethernet_ds_pmhd_rx_packet_count = 5,
	omci_me_ethernet_ds_pmhd_rx_broadcast_packet_count = 6,
	omci_me_ethernet_ds_pmhd_rx_multicast_packet_count = 7,
	omci_me_ethernet_ds_pmhd_fcs_error_count = 8,
	omci_me_ethernet_ds_pmhd_rx_undersized_packet_count = 9,
	omci_me_ethernet_ds_pmhd_rx_oversized_packet_count = 10,
	omci_me_ethernet_ds_pmhd_rx_frame64_count = 11,
	omci_me_ethernet_ds_pmhd_rx_frame127_count = 12,
	omci_me_ethernet_ds_pmhd_rx_frame255_count = 13,
	omci_me_ethernet_ds_pmhd_rx_frame511_count = 14,
	omci_me_ethernet_ds_pmhd_rx_frame1023_count = 15,
	omci_me_ethernet_ds_pmhd_rx_frame1518_count = 16
};
