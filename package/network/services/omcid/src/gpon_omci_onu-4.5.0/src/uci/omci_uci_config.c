...
static int network_parse_ip(void *section, struct uci_optmap *om,
			    union ucimap_data *data, const char *str)
{
...
static int network_format_ip(void *section, struct uci_optmap *om,
			     union ucimap_data *data, char **str)
{
	static char buf[16];
...
static void network_free_ip(void *section, struct uci_optmap *om, void *ptr)
{
	free(ptr);
}

static int network_init_interface(struct uci_map *map,
				  void *section, struct uci_section *s)
{
...
static int network_init_alias(struct uci_map *map,
			      void *section, struct uci_section *s)
{
...
static int network_add_interface(struct uci_map *map, void *section)
{
	struct uci_network *net = section;
...
static int network_add_alias(struct uci_map *map, void *section)
{
...
static struct ucimap_section_data *network_allocate(struct uci_map *map,
