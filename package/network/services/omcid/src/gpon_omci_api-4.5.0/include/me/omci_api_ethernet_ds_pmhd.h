...
******************************************************************************/
#ifndef _omci_api_me_ethernet_ds_pmhd_h
#define _omci_api_me_ethernet_ds_pmhd_h
...
/** \defgroup OMCI_API_ME_ETHERNET_DS_PMHD Ethernet Frame PMHD Downstream

   This Managed Entity is identical to the Ethernet frame performance
   monitoring history data upstream Managed Entity, with the exception that it
...
/** Retrieve current value of Ethernet Frame PMHD Downstream counters
...
/** Set Ethernet Frame PMHD Downstream counters thresholds
...
/** Retrieve cumulative (total) Ethernet Frame DS PMHD counters */
enum omci_api_return
