...
******************************************************************************/
#ifndef _drv_onu_devio_h
#define _drv_onu_devio_h
...
#define _IFXOS_IO(type,nr) \
	_IFXOS_IOC(_IFXOS_IOC_NONE,(type),(nr),0)

#define _IFXOS_IOR(type,nr,size) \
	_IFXOS_IOC(_IFXOS_IOC_READ,(type),(nr),(_IFXOS_IOC_TYPECHECK(size)))

#define _IFXOS_IOW(type,nr,size) \
	_IFXOS_IOC(_IFXOS_IOC_WRITE,(type),(nr),(_IFXOS_IOC_TYPECHECK(size)))

#define _IFXOS_IOWR(type,nr,size) \
	_IFXOS_IOC(_IFXOS_IOC_READ|_IFXOS_IOC_WRITE,(type),(nr), \
		   (_IFXOS_IOC_TYPECHECK(size)))

#define _IFXOS_IOR_BAD(type,nr,size) \
	_IFXOS_IOC(_IFXOS_IOC_READ,(type),(nr),sizeof(size))

#define _IFXOS_IOW_BAD(type,nr,size) \
	_IFXOS_IOC(_IFXOS_IOC_WRITE,(type),(nr),sizeof(size))

#define _IFXOS_IOWR_BAD(type,nr,size) \
	_IFXOS_IOC(_IFXOS_IOC_READ|_IFXOS_IOC_WRITE,(type),(nr),sizeof(size))

#define _IFXOS_IOC_DIR(nr) \
	(((nr) >> _IFXOS_IOC_DIRSHIFT) & _IFXOS_IOC_DIRMASK)

#define _IFXOS_IOC_TYPE(nr) \
	(((nr) >> _IFXOS_IOC_TYPESHIFT) & _IFXOS_IOC_TYPEMASK)

#define _IFXOS_IOC_NR(nr) \
	(((nr) >> _IFXOS_IOC_NRSHIFT) & _IFXOS_IOC_NRMASK)

#define _IFXOS_IOC_SIZE(nr) \
	(((nr) >> _IFXOS_IOC_SIZESHIFT) & _IFXOS_IOC_SIZEMASK)
